...
public class EntityDtoMapper {
    ...
    public OrderItemsDto mapOrderItemToDtoBasic(OrderItems orderItem){
    ...
    public OrderItemsDto mapOrderItemToDtoPlusProduct(OrderItems orderItem){
        OrderItemsDto orderItemDto = mapOrderItemToDtoBasic(orderItem);
    ...
    public OrderItemsDto mapOrderItemToDtoPlusProductAndUser(OrderItems orderItem){
        OrderItemsDto orderItemDto = mapOrderItemToDtoPlusProduct(orderItem);
