...
public class JwtUtils {
    private static final long EXPIRSATION_TIME_IN_MILLISEC = 1000L* 60L *60L* 24L *30L * 6L;
    ...
    public String generateToken(String username){
        return Jwts.builder().subject(username).issuedAt(new Date(System.currentTimeMillis()))
                .expiration(new Date(System.currentTimeMillis()*EXPIRSATION_TIME_IN_MILLISEC)).signWith(key).compact();
    }
