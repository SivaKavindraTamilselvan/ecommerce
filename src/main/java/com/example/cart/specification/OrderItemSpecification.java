package com.example.cart.specification;
...
public class OrderItemSpecification {
    ...
    public static Specification<OrderItems> hasStatus(OrderStatus status){
    ...
    public static Specification<OrderItems> createdBetween(LocalDateTime startDate, LocalDateTime endDate){
        return ((root, query, criteriaBuilder) -> {
    ...
    public static Specification<OrderItems> hasItemId(Long itemId){
        return ((root, query, criteriaBuilder) ->
